...
struct CIMGetMsgListReqDefaultTypeInternal;
...
class CIMRecentContactSessionReq final :
 ...
 public:
  ...
  ~CIMRecentContactSessionReq() override;
  explicit PROTOBUF_CONSTEXPR CIMRecentContactSessionReq(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  CIMRecentContactSessionReq* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
...
class CIMRecentContactSessionRsp final :
 ...
 public:
  ...
  ~CIMRecentContactSessionRsp() override;
  explicit PROTOBUF_CONSTEXPR CIMRecentContactSessionRsp(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  CIMRecentContactSessionRsp* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  uint32_t unread_counts() const;
  void set_unread_counts(uint32_t value);
  private:
  uint32_t _internal_unread_counts() const;
  void _internal_set_unread_counts(uint32_t value);
  public:
 ...
 private:
  ...
  uint64_t user_id_;
  uint32_t unread_counts_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_CIM_2eList_2eproto;
};
// -------------------------------------------------------------------

class CIMGetMsgListReq final :
 ...
 public:
  ...
  ~CIMGetMsgListReq() override;
  explicit PROTOBUF_CONSTEXPR CIMGetMsgListReq(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  CIMGetMsgListReq* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  uint64_t end_msg_id() const;
  void set_end_msg_id(uint64_t value);
  private:
  uint64_t _internal_end_msg_id() const;
  void _internal_set_end_msg_id(uint64_t value);
  public:
...
class CIMGetMsgListRsp final :
 ...
 public:
  ...
  ~CIMGetMsgListRsp() override;
  explicit PROTOBUF_CONSTEXPR CIMGetMsgListRsp(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  CIMGetMsgListRsp* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
...
inline uint64_t CIMRecentContactSessionReq::_internal_user_id() const {
  return user_id_;
}
inline uint64_t CIMRecentContactSessionReq::user_id() const {
  // @@protoc_insertion_point(field_get:CIM.List.CIMRecentContactSessionReq.user_id)
  return _internal_user_id();
}
inline void CIMRecentContactSessionReq::_internal_set_user_id(uint64_t value) {
  
  user_id_ = value;
}
inline void CIMRecentContactSessionReq::set_user_id(uint64_t value) {
...
inline uint32_t CIMRecentContactSessionReq::_internal_latest_update_time() const {
  return latest_update_time_;
}
inline uint32_t CIMRecentContactSessionReq::latest_update_time() const {
...
inline void CIMRecentContactSessionReq::_internal_set_latest_update_time(uint32_t value) {
  
  latest_update_time_ = value;
}
inline void CIMRecentContactSessionReq::set_latest_update_time(uint32_t value) {
...
inline uint64_t CIMRecentContactSessionRsp::_internal_user_id() const {
  return user_id_;
}
inline uint64_t CIMRecentContactSessionRsp::user_id() const {
  // @@protoc_insertion_point(field_get:CIM.List.CIMRecentContactSessionRsp.user_id)
  return _internal_user_id();
}
inline void CIMRecentContactSessionRsp::_internal_set_user_id(uint64_t value) {
  
  user_id_ = value;
}
inline void CIMRecentContactSessionRsp::set_user_id(uint64_t value) {
  _internal_set_user_id(value);
...
inline uint32_t CIMRecentContactSessionRsp::_internal_unread_counts() const {
  return unread_counts_;
}
inline uint32_t CIMRecentContactSessionRsp::unread_counts() const {
  // @@protoc_insertion_point(field_get:CIM.List.CIMRecentContactSessionRsp.unread_counts)
  return _internal_unread_counts();
}
inline void CIMRecentContactSessionRsp::_internal_set_unread_counts(uint32_t value) {
  
  unread_counts_ = value;
}
inline void CIMRecentContactSessionRsp::set_unread_counts(uint32_t value) {
...
inline ::CIM::Def::CIMContactSessionInfo* CIMRecentContactSessionRsp::add_contact_session_list() {
  ::CIM::Def::CIMContactSessionInfo* _add = _internal_add_contact_session_list();
...
inline uint64_t CIMGetMsgListReq::_internal_user_id() const {
  return user_id_;
}
inline uint64_t CIMGetMsgListReq::user_id() const {
  // @@protoc_insertion_point(field_get:CIM.List.CIMGetMsgListReq.user_id)
  return _internal_user_id();
}
inline void CIMGetMsgListReq::_internal_set_user_id(uint64_t value) {
  
  user_id_ = value;
}
inline void CIMGetMsgListReq::set_user_id(uint64_t value) {
  _internal_set_user_id(value);
...
inline uint64_t CIMGetMsgListReq::_internal_session_id() const {
  return session_id_;
}
inline uint64_t CIMGetMsgListReq::session_id() const {
  // @@protoc_insertion_point(field_get:CIM.List.CIMGetMsgListReq.session_id)
  return _internal_session_id();
}
inline void CIMGetMsgListReq::_internal_set_session_id(uint64_t value) {
  
  session_id_ = value;
}
inline void CIMGetMsgListReq::set_session_id(uint64_t value) {
...
inline uint64_t CIMGetMsgListReq::_internal_end_msg_id() const {
  return end_msg_id_;
}
inline uint64_t CIMGetMsgListReq::end_msg_id() const {
  // @@protoc_insertion_point(field_get:CIM.List.CIMGetMsgListReq.end_msg_id)
  return _internal_end_msg_id();
}
inline void CIMGetMsgListReq::_internal_set_end_msg_id(uint64_t value) {
  
  end_msg_id_ = value;
}
inline void CIMGetMsgListReq::set_end_msg_id(uint64_t value) {
...
inline uint32_t CIMGetMsgListReq::_internal_limit_count() const {
  return limit_count_;
}
inline uint32_t CIMGetMsgListReq::limit_count() const {
  // @@protoc_insertion_point(field_get:CIM.List.CIMGetMsgListReq.limit_count)
  return _internal_limit_count();
}
inline void CIMGetMsgListReq::_internal_set_limit_count(uint32_t value) {
  
  limit_count_ = value;
}
inline void CIMGetMsgListReq::set_limit_count(uint32_t value) {
...
inline uint64_t CIMGetMsgListRsp::_internal_user_id() const {
  return user_id_;
}
inline uint64_t CIMGetMsgListRsp::user_id() const {
  // @@protoc_insertion_point(field_get:CIM.List.CIMGetMsgListRsp.user_id)
  return _internal_user_id();
}
inline void CIMGetMsgListRsp::_internal_set_user_id(uint64_t value) {
  
  user_id_ = value;
}
inline void CIMGetMsgListRsp::set_user_id(uint64_t value) {
  _internal_set_user_id(value);
...
inline uint64_t CIMGetMsgListRsp::_internal_session_id() const {
  return session_id_;
}
inline uint64_t CIMGetMsgListRsp::session_id() const {
  // @@protoc_insertion_point(field_get:CIM.List.CIMGetMsgListRsp.session_id)
  return _internal_session_id();
}
inline void CIMGetMsgListRsp::_internal_set_session_id(uint64_t value) {
  
  session_id_ = value;
}
inline void CIMGetMsgListRsp::set_session_id(uint64_t value) {
  _internal_set_session_id(value);
...
inline uint64_t CIMGetMsgListRsp::_internal_end_msg_id() const {
  return end_msg_id_;
}
inline uint64_t CIMGetMsgListRsp::end_msg_id() const {
  // @@protoc_insertion_point(field_get:CIM.List.CIMGetMsgListRsp.end_msg_id)
  return _internal_end_msg_id();
}
inline void CIMGetMsgListRsp::_internal_set_end_msg_id(uint64_t value) {
  
  end_msg_id_ = value;
}
inline void CIMGetMsgListRsp::set_end_msg_id(uint64_t value) {
  _internal_set_end_msg_id(value);
